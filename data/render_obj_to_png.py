...
def obj_to_png(obj_path,file_num):
    ...
    stepsize_horizontal = 60.0 / (views - 1)  # -45도에서 45도까지의 각도를 나누기 위해
    ...
    for k in range(views):
        for i in range(views):
            ...
            angle_horizontal = -30 + stepsize_horizontal * i + 180
...
def main():
    ...
    obj_to_png(args.file_path, args.file_num)
